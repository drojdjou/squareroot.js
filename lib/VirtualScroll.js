...
var VirtualScroll = (function(document) {
	...
	var onWheel = function(e) {
		...
		// In Chrome, IE and in Firefox (at least the new one)
		event.deltaX = e.wheelDeltaX || e.deltaX || 0;
		event.deltaY = e.wheelDeltaY || e.deltaY || 0;
	...
	var onMouseWheel = function(e) {
		...
		event.deltaX = e.wheelDeltaX || 0;
		event.deltaY = e.wheelDeltaY || e.wheelDelta || 0;
