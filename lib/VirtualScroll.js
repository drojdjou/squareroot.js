...
var VirtualScroll = (function(document) {
	...
	var onTouchMove = function(e) {
		...
		window.live.innerHTML = e.targetTouches + " | " + e.pageX + " " + e.pageY;
	...
	var initListeners = function() {
		...
		if(hasPointer) {
			...
			document.addEventListener("MSPointerCancel", function(e) {
				window.debug.innerHTML += "touchCancel<br>";
			});

			document.addEventListener("MSPointerOut", function(e) {
				window.debug.innerHTML += "touchOut<br>";
			});

			document.addEventListener("MSPointerLeave", function(e) {
				window.debug.innerHTML += "touchLeave<br>";
			});
		}
