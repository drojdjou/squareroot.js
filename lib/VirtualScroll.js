...
var VirtualScroll = (function(document) {
	...
	var onTouchStart = function(e) {
		...
		//
		if(vs.whichListener.indexOf("onTouchStart") == -1) vs.whichListener.push("onTouchStart");
		//
	...
	var onTouchMove = function(e) {
		...
		//
		if(vs.whichListener.indexOf("onTouchMove") == -1) vs.whichListener.push("onTouchMove");
		//
