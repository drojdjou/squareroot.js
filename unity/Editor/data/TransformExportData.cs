...
public class TransformExportData
{
	...
	public string AnimationName {
		get { return NamesUtil.CleanLc (t.GetComponent<Animator>().runtimeAnimatorController.animationClips[0].name); }
	}

	public string AnimationId {
		get { return "a" + t.GetComponent<Animator>().runtimeAnimatorController.animationClips[0].GetInstanceID(); }
	}
	...
	public bool HasAnimation {
		get { return t.GetComponent<Animator>() != null; }
	}
