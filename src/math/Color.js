/**
 * Represents a color (rgb or hsl) and provides tools to convert between those two representations.
 */
SQR.Color = function(useAlpha) {
    ...
    /**
     *  Set this to 3 to discard alpha or 4 to use alpha.
     */
    this.size = (useAlpha) ? 4 : 3;
    ...
    this.toBuffer = function(buffer, index) {
        ...
        buffer[index+1] = g;
        buffer[index+2] = b;
        if(this.size > 3) buffer[index+3] = a;
    }
